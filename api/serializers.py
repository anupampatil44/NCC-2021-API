...
class QuestionSerializer(serializers.ModelSerializer):
    class Meta:
        model = Question
        fields = ('pk', 'question_title', 'question_desc', 'correct_attempts', 'total_attempts', 'max_marks')

class Codingpageserializer(serializers.ModelSerializer):
    class Meta:
        model = Question
        fields = ('pk', 'question_title', 'question_desc', 'constraints', 'explanation', 'iformat','oformat','sampleInput','sampleOutput')
